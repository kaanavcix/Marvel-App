...
mixin _$RegisterState {
  RegisterEnum get state => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      pins: freezed == pins
          ...
          : pins // ignore: cast_nullable_to_non_nullable
              as List<int>?,
      isWhich: freezed == isWhich
          ? _value.isWhich
          : isWhich // ignore: cast_nullable_to_non_nullable
              as int?,
    ) as $Val);
  }
}
...
abstract class _Initial implements RegisterState {
  const factory _Initial(
      {required final RegisterEnum state,
